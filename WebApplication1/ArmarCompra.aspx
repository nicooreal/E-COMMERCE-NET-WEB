<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="ArmarCompra.aspx.cs" Inherits="WebApplication1.ArmarCompra" %>
...
<br />
            ...
            <div>
        <asp:Button ID="ButtonSumarProductoEnCompra" runat="server" Text="AGREGAR"  class="btn btn-primary" OnClick="ButtonSumarProductoEnCompra_Click" />
